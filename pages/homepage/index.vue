<template>
  <!-- Removed container and head tag-->
  <v-parallax src="@/assets/coffeeHome.jpg">
    ...
    <v-card>
      <v-tabs v-model="tab" color="rgb(240, 200, 165)" align-tabs="center">
        ...
        <v-tab :value="2">Type coffee beans</v-tab>
        <v-tab :value="3">Blog</v-tab>
        <v-tab :value="4">News</v-tab>
        <v-tab :value="5">Contact</v-tab>
      </v-tabs>
    </v-card>

    <!-- Remove max-width -->
    <v-card class="mx-auto" color="rgba(200, 176, 153, 0.7)">
      <v-row>
        ...
        <v-col align-self="center">
          <div class="justify-end">
            <!-- Put new image below, then adjust image width-->
            <v-img width="200" src="@/assets/logo.png" />
          </div>
        </v-col>
      </v-row>
    </v-card>
